...
//        set2.setFillColor(ContextCompat.getColor(context, R.color.red));
    ...
    public List<List<Entry>> getEntries() {
        ...
        yVals1.add(new Entry(1, 194, calendar.getTime()));
        calendar.set(2018, 1, 2);
        yVals1.add(new Entry(2, 220, calendar.getTime()));
        calendar.set(2018, 1, 3);
        yVals1.add(new Entry(3, 154, calendar.getTime()));
        calendar.set(2018, 1, 4);
        yVals1.add(new Entry(4, 120, calendar.getTime()));
        calendar.set(2018, 1, 5);
        yVals1.add(new Entry(5, 126, calendar.getTime()));
        calendar.set(2018, 1, 6);
        yVals1.add(new Entry(6, 126, calendar.getTime()));
        calendar.set(2018, 1, 7);
        yVals1.add(new Entry(7, 131, calendar.getTime()));
        calendar.set(2018, 1, 8);
        yVals1.add(new Entry(8, 134, calendar.getTime()));
        calendar.set(2018, 1, 9);
        yVals1.add(new Entry(9, 150, calendar.getTime()));
        calendar.set(2018, 1, 10);
        yVals1.add(new Entry(10, 171, calendar.getTime()));
        calendar.set(2018, 1, 11);
        yVals1.add(new Entry(11, 184, calendar.getTime()));
        calendar.set(2018, 1, 12);
        yVals1.add(new Entry(12, 189, calendar.getTime()));
        calendar.set(2018, 1, 13);
        yVals1.add(new Entry(13, 225, calendar.getTime()));
        calendar.set(2018, 1, 14);
        yVals1.add(new Entry(14, 269, calendar.getTime()));
